...
describe('motionSensors', () => {
  describe('parseMotionSensors', () => {
    ...
    it('should parse MotionAware zones correctly', () => {
      ...
      const result = parseMotionSensors(behaviors, motionAreas);
