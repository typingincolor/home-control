...
describe('hueApi', () => {
  ...
  describe('session token management', () => {
    it('should store session token via setSessionToken', () => {
      setSessionToken('test-token-123');
      expect(getSessionToken()).toBe('test-token-123');
    });

    it('should clear session token via clearSessionToken', () => {
      setSessionToken('test-token-123');
      clearSessionToken();
    ...
    it('should include Authorization header in requests when token is set', async () => {
      setSessionToken('test-token-123');
  ...
  describe('getDashboard', () => {
    it('should send GET request with Authorization header when token is set', async () => {
      setSessionToken('hue_sess_test123');
      const mockDashboard = {
      ...
      const result = await hueApi.getDashboard();
  ...
  describe('getMotionZones', () => {
    it('should send GET request with Authorization header when token is set', async () => {
      ...
      const result = await hueApi.getMotionZones();
  ...
  describe('updateLight', () => {
    it('should send PUT request with correct headers and body', async () => {
      ...
      const result = await hueApi.updateLight('light-1', {
        on: true,
        brightness: 80,
      });
  ...
  describe('updateRoomLights', () => {
    it('should send PUT request with correct parameters', async () => {
      ...
      const result = await hueApi.updateRoomLights('room-1', { on: true });
  ...
  describe('updateZoneLights', () => {
    it('should send PUT request with correct parameters', async () => {
      ...
      const result = await hueApi.updateZoneLights('zone-1', { on: true });
  ...
  describe('activateSceneV1', () => {
    it('should send POST request with Authorization header', async () => {
      ...
      const result = await hueApi.activateSceneV1('scene-1');
  ...
  describe('refreshSession', () => {
    it('should send POST request with Authorization header', async () => {
      setSessionToken('hue_sess_old123');
      ...
      const result = await hueApi.refreshSession();
  ...
  describe('revokeSession', () => {
    it('should send DELETE request with Authorization header', async () => {
      ...
      const result = await hueApi.revokeSession();
  ...
  describe('settings API', () => {
    it('getSettings should fetch settings with authorization', async () => {
      ...
      const result = await hueApi.getSettings();
    ...
    it('updateSettings should send PUT request with settings', async () => {
      ...
      const result = await hueApi.updateSettings(newSettings);
    ...
    it('updateLocation should send PUT request to location endpoint', async () => {
      ...
      await hueApi.updateLocation(location);
  ...
  describe('weather API', () => {
    it('getWeather should fetch weather with authorization', async () => {
      ...
      const result = await hueApi.getWeather();
  ...
  describe('automations API', () => {
    it('getAutomations should fetch automations with authorization', async () => {
      ...
      const result = await hueApi.getAutomations();
    ...
    it('triggerAutomation should send POST request to trigger endpoint', async () => {
      ...
      const result = await hueApi.triggerAutomation('automation-1');
    ...
    it('triggerAutomation should throw error on failure', async () => {
      ...
      await expect(hueApi.triggerAutomation('invalid-id')).rejects.toThrow('Automation not found');
    });
  });
