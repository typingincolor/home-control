  ...
  return (
    <div className="authentication">
      ...
      <div className="bridge-info">
        <p>
          {UI_TEXT.AUTH_BRIDGE_IP_LABEL} <strong>{bridgeIp}</strong>
        </p>
      </div>
      ...
      {error && (
        <div className="error-box">
          ...
          {error.includes('CORS') ||
            (error.includes('Browser security') && (
              <div className="cors-help">
                <h5>CORS Troubleshooting:</h5>
                <p>The browser is blocking requests to your bridge. Try these solutions:</p>
                <ul>
                  <li>
                    Install a CORS browser extension (e.g., &quot;Allow CORS&quot; or &quot;CORS
                    Unblock&quot;)
                  </li>
                  <li>
                    Visit <code>http://{bridgeIp}/api/config</code> directly in a new tab first
                  </li>
